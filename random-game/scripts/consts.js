...
/* export const GUARD_ENEMIES_PROPS = { x: CANVAS_WIDTH - 50, y: CANVAS_HEIGHT, width: 50, height: 100, hp: MAX_ENEMY_HP, power: 0.1 };
export const KNIGHT_ENEMIES_PROPS = { x: CANVAS_WIDTH - 50, y: CANVAS_HEIGHT + 20, width: 50, height: 100, hp: MAX_ENEMY_HP, power: 0.1 }; */
