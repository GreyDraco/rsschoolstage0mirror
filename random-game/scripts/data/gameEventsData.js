export const gameEventsData = {
  ...
  city1: {
    immediateBattle: {
      ...
      varID: "imBattle",
      rewards: { gold: 1000 },
      battle: { guard: 14, knight: 8, archer: 3 },
  ...
  city2: {
    immediateBattle: {
      ...
      varID: "imBattle",
      rewards: { gold: 2500 },
      battle: { guard: 20, knight: 10, archer: 5 },
      ...
      var1: {
        ...
        vars: {
              ...
              var2: {
                ...
                vars: {
                  var1: {
                    ...
                    check: null,
                    battle: { guard: 20, knight: 15, archer: 8 },
                  },
                  var2: {
          ...
          varl: {
            ...
            rewards: null,
            check: null,
            battle: { guard: 14, knight: 10, archer: 5 },
          },
        },
        rewards: null,
        check: { lvlCheck: 3 },
              ...
              var2: {
                ...
                vars: {
                  var1: {
                    ...
                    check: null,
                    battle: { guard: 20, knight: 15, archer: 5 },
                  },
                  var2: {
                    varDesc: "Оставить принцессу себе",
                    varID: "var3l",
  ...
  king: {
    ...
    check: null,
    vars: null,
    battle: { guard: 30, knight: 20, archer: 10, king: 1 },
  },
};
